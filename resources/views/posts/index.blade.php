...
<form class="flex items-center max-w-sm mx-auto mb-8" action="{{ route('user.search') }}" method="GET">
    @csrf
    ...
    <button type="submit" class="p-2.5 ms-2 text-sm font-medium text-white bg-purple-600 hover:bg-purple-700 rounded-lg border border-purple-700 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
...
<h1 class="text-4xl font-extrabold text-center mt-8 mb-8 text-gray-900 dark:text-white">Latest Posts</h1>
<!-- we can use this to show an image <img src="{{ asset('storage/posts_image/78fI8LYdmju2YYH0xPeybLbqqQ7TTihBFKShYclx.png')}}" alt=""/> -->
